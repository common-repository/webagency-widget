<!-- Header
		...
		<header id="header" class="full-header dark">
			...
			<div id="header-wrap">
				...
				{else}
    			<a href="#" class="standard-logo" data-dark-logo="{$WAW_PLUGIN_WWW}/templates/default/images/logo-dark.png"><img src="{$WAW_PLUGIN_WWW}/templates/default/images/logo-dark.png" alt="{$business->name}"></a>
			<a href="#" class="retina-logo" data-dark-logo="{$WAW_PLUGIN_WWW}/templates/default/images/logo-dark.png"><img src="{$WAW_PLUGIN_WWW}/templates/default/images/logo-dark.png" alt="{$business->name}"></a>
