									...
									<div class="slider-wrap">
										...
										<div class="slide">
											<div class="testi-image">
												<a href="#"><img src="{$WAW_WWW}/wrimage/?width=200&height=200&cropratio=1:1&image={$WAW_CONTENT_WWW}testimonials/{$id_users}/{$itemtestimonial->image}" alt="{$itemtestimonial->name}" alt="Customer Testimonails"></a>
											</div>
