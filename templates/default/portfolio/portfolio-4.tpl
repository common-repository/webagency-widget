								...
								<div class="fslider" data-arrows="false">
									<div class="flexslider">
										<div class="slider-wrap">
											...
											<div class="slide"><a href="{$WAW_CONTENT_WWW}projects_images/{$id_users}/{$projectimage->image}"><img src="{$WAW_WWW}/wrimage/?width=400&height=300&cropratio=1.3:1&image={$WAW_CONTENT_WWW}projects_images/{$id_users}/{$projectimage->image}" alt="{$itemtestimonial->name}" alt="{$project->project_name}"></a></div>
											{/foreach}
										</div>
									</div>
								</div>
